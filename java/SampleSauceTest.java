...
public class SampleSauceTest implements SauceOnDemandSessionIdProvider {
	 ...
	 */
	@Rule
	public SauceOnDemandTestWatcher2 resultReportingTestWatcher = new SauceOnDemandTestWatcher2(
			this, authentication);
	...
	public void amazon() throws Exception {
		...
		// intentionally fail test by checking for "AAmazon"
		assertEquals(
				"AAmazon.com: Online Shopping for Electronics, Apparel, Computers, Books, DVDs & more",
				driver.getTitle());
	}
